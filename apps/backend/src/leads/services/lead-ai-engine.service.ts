    ...
    switch (lead.status) {
      case LeadStatus.NEW:
        if (isSlaBreached) {
          return {
            ...
            reason:
              'No contact has been made within 24 hours. This lead is at high risk of conversion.',
            action: 'call',
            priority: 'urgent',
            ctaLabel: 'Call Now',
          };
        ...
        return {
          ...
          reason:
            'New leads have the highest conversion probability when contacted quickly.',
      ...
      case LeadStatus.CONTACTED:
        if (isLongNoResponse) {
          return {
            ...
            reason:
              'No response for 7+ days. Try a different communication channel.',
            action: 'whatsapp',
            priority: 'high',
        ...
        return {
          ...
          reason:
            'Gather more information to determine lead quality and match with properties.',
          action: 'note',
          priority: 'medium',
          ctaLabel: 'Add Note',
        };
      ...
      case LeadStatus.RNR:
        return {
          ...
          reason:
            'Lead is not responding to calls. Try WhatsApp or schedule a callback.',
          action: 'whatsapp',
          priority: 'high',
          ctaLabel: 'Send WhatsApp',
        };
      ...
      case LeadStatus.SITE_VISIT_SCHEDULED:
        if (
          followUp &&
          followUp.getTime() - now.getTime() < 2 * 60 * 60 * 1000
        ) {
          return {
            suggestion: 'Send visit reminder 2 hours before',
            reason:
              'Site visit is scheduled soon. Send reminder to confirm attendance.',
            action: 'whatsapp',
            priority: 'urgent',
      ...
      case LeadStatus.SITE_VISIT_DONE:
        return {
          ...
          reason:
            'Visit completed. Gather feedback and discuss next steps or pricing.',
          action: 'call',
          priority: 'high',
      ...
      case LeadStatus.NEGOTIATION:
        return {
          ...
          reason:
            'Lead is in negotiation. Use scarcity tactics and close the deal.',
          action: 'call',
          priority: 'high',
          ctaLabel: 'Close Deal',
        };
      ...
      case LeadStatus.BOOKED:
        return {
          ...
          reason:
            'Lead is booked. Ensure all paperwork and token amounts are collected.',
          action: 'note',
          priority: 'high',
          ctaLabel: 'Add Note',
        };
      ...
      case LeadStatus.LOST:
        return {
          ...
          reason:
            'Lead is lost but may revive. Add to long-term nurturing workflow.',
          action: 'note',
          priority: 'low',
          ctaLabel: 'Add Note',
        };
      ...
      default:
        return {
          ...
          reason:
            'Review the lead details and notes to decide on the next action.',
          action: 'note',
          priority: 'medium',
