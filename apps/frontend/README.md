...
- **💸 Deal Pipeline**: Visualized deal stages from negotiation to closing.
- **📅 Activity Tracking**: Integrated task management and activity logs.
- **💬 Messaging Center**: Unified chat interface for internal and client communication.
...
1. Clone the repository:
   ```bash
   git clone https://github.com/rahulp772/frontend-real-estate-crm.git
